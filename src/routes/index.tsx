...
export default component$(() => {
  return (
    <div style={{display: 'flex', gap: '2rem', alignItems: 'flex-start'}}>
      <div class="glass-card route-content">
        I'm a 26 year old CS Masters Student at BYU. I have 
        worked on a variety of projects including a ML application at <a href="https://www.securitymetrics.com/">SecurityMetrics</a>,
        ...
        developing a web app for crowd sourcing wedding venues, and lead development on
        <a href="">Treasury4</a>'s informational website. I am currently working in the
